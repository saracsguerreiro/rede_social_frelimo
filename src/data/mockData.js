...
export const membrosAdmin = [
  {
    id: 1, nome: 'Américo Muteia', cartao: 'FREL-2019-047821',
    dataNascimento: '1975-03-12', sexo: 'M',
    telefone: '+258 84 123 4567', email: 'a.muteia@frelimo.mz',
    celula: 'Célula 7 — Polana Cimento',
    orgao: 'Comité Provincial de Maputo', cargo: 'Secretário Provincial',
    dataFiliacao: '2019-01-15', nivel: 'Provincial',
    quotas: 'em_dia', ultimoPagamento: '2026-07-01', avatar: 'AM',
  },
  {
    id: 2, nome: 'Fátima Cossa', cartao: 'FREL-2015-012340',
    dataNascimento: '1980-09-22', sexo: 'F',
    telefone: '+258 82 987 6543', email: 'f.cossa@frelimo.mz',
    celula: 'Célula 2 — Sommerschield',
    orgao: 'Comité Central', cargo: 'Membro do CC',
    dataFiliacao: '2015-06-10', nivel: 'Nacional',
    quotas: 'em_dia', ultimoPagamento: '2026-07-03', avatar: 'FC',
  },
  {
    id: 3, nome: 'João Nhantumbo', cartao: 'FREL-2021-089012',
    dataNascimento: '1990-05-18', sexo: 'M',
    telefone: '+258 86 555 1234', email: 'j.nhantumbo@frelimo.mz',
    celula: 'Célula 1 — Centro Matola',
    orgao: 'Comité Distrital da Matola', cargo: 'Secretário Distrital',
    dataFiliacao: '2021-03-20', nivel: 'Distrital',
    quotas: 'em_dia', ultimoPagamento: '2026-06-28', avatar: 'JN',
  },
  {
    id: 4, nome: 'Maria Sitoe', cartao: 'FREL-2018-034567',
    dataNascimento: '1983-11-04', sexo: 'F',
    telefone: '+258 84 321 7890', email: 'm.sitoe@frelimo.mz',
    celula: 'Célula 4 — Maxaquene',
    orgao: 'Comité Provincial de Maputo', cargo: 'Secretária Adjunta',
    dataFiliacao: '2018-09-05', nivel: 'Provincial',
    quotas: 'em_atraso', ultimoPagamento: '2026-03-15', avatar: 'MS',
  },
  {
    id: 5, nome: 'Carlos Mondlane Jr.', cartao: 'FREL-2020-056789',
    dataNascimento: '1995-07-30', sexo: 'M',
    telefone: '+258 85 444 2222', email: 'c.mondlane@ojm.mz',
    celula: 'Célula OJM — Maputo-Cidade',
    orgao: 'OJM Nacional', cargo: 'Secretário-Geral OJM',
    dataFiliacao: '2020-02-14', nivel: 'Nacional',
    quotas: 'em_dia', ultimoPagamento: '2026-07-05', avatar: 'CM',
  },
  {
    id: 6, nome: 'Rosa Baloi', cartao: 'FREL-2017-023456',
    dataNascimento: '1978-02-14', sexo: 'F',
    telefone: '+258 82 111 3333', email: 'r.baloi@omm.mz',
    celula: 'Célula OMM — Maputo',
    orgao: 'OMM Nacional', cargo: 'Secretária-Geral OMM',
    dataFiliacao: '2017-11-25', nivel: 'Nacional',
    quotas: 'em_dia', ultimoPagamento: '2026-07-02', avatar: 'RB',
  },
  {
    id: 7, nome: 'Helder Guambe', cartao: 'FREL-2022-101234',
    dataNascimento: '1988-12-01', sexo: 'M',
    telefone: '+258 84 777 8888', email: 'h.guambe@frelimo.mz',
    celula: 'Célula 3 — Boane-Sede',
    orgao: 'Comité Distrital de Boane', cargo: 'Secretário Distrital',
    dataFiliacao: '2022-08-30', nivel: 'Distrital',
    quotas: 'em_dia', ultimoPagamento: '2026-07-10', avatar: 'HG',
  },
  {
    id: 8, nome: 'Ana Chambal', cartao: 'FREL-2016-019876',
    dataNascimento: '1982-06-09', sexo: 'F',
    telefone: '+258 86 666 5555', email: 'a.chambal@frelimo.mz',
    celula: 'Célula 5 — Xai-Xai',
    orgao: 'Comité Provincial de Gaza', cargo: 'Membro CP',
    dataFiliacao: '2016-04-18', nivel: 'Provincial',
    quotas: 'em_atraso', ultimoPagamento: '2026-01-20', avatar: 'AC',
  },
  {
    id: 9, nome: 'Manuel Macuácua', cartao: 'FREL-2014-008765',
    dataNascimento: '1970-08-25', sexo: 'M',
    telefone: '+258 82 222 9999', email: 'm.macuacua@frelimo.mz',
    celula: 'Célula 1 — Cidade de Nampula',
    orgao: 'Comité Provincial de Nampula', cargo: 'Secretário Provincial',
    dataFiliacao: '2014-12-03', nivel: 'Provincial',
    quotas: 'em_atraso', ultimoPagamento: '2026-02-10', avatar: 'MM',
  },
  {
    id: 10, nome: 'Lurdes Machava', cartao: 'FREL-2023-115678',
    dataNascimento: '1998-04-17', sexo: 'F',
    telefone: '+258 85 333 4444', email: 'l.machava@frelimo.mz',
    celula: 'Célula 9 — Hulene',
    orgao: 'OJM — Maputo', cargo: 'Secretária Adjunta OJM',
    dataFiliacao: '2023-05-01', nivel: 'Provincial',
    quotas: 'em_dia', ultimoPagamento: '2026-07-08', avatar: 'LM',
  },
];
